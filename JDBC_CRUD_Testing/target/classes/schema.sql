CREATE TABLE easy_drinks (id INT NOT NULL Primary key AUTO_INCREMENT, name VARCHAR(16), main VARCHAR(20), amount1 DOUBLE, second VARCHAR(20), amount2 DOUBLE, directions VARCHAR(250));

INSERT INTO easy_drinks(name, main, amount1, second, amount2, directions) VALUES 
